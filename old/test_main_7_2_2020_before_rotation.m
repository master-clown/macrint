...
function test_main_7_2_2020_before_rotation()
    ...
    %test_2collinear_rotate([0.0:pi/72:5*pi/36, 6*pi/36 : pi/36 : pi/2], [ true, true, true ]);
...
%         dist_from_zero = cdist / 2;
% 
%         cr_center_lst = [ dist_from_zero, 0.0;
%                          -dist_from_zero, 0.0 ];
%         cr_phi_lst = [ pi/2, pi/2 ];
%         cr_len_lst = [ hlen, hlen ];
% 
%         ext_st = [1.0, 0.0, 0.0];
% 
